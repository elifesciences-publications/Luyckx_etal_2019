...
%
% Input
%   - dat: subjects x any n dimensions
%   - nSims: number of shuffle iterations
%   - p_crit: p-value to test in permutation population
%   - p_thresh: p-value to select clusters for permutation population
%
% Output:
%   - p: surviving p-values after correction
%   - praw: raw p-values
