...
%       6    'MapStyle' - Color bar style [ 'hot' | 'cool' | 'autumn' | 'winter' | 'summer' | 'spring' | 'gray' | 'jet'  (default)]. It will also accept a 3xn matrix of RGB values for custom plots.
...
%       19  'Steps' - Controls how many steps are included in the colormap.  Default is 512.
%
%   Example Code:
%       
...
%   Author: Matthew B. Pontifex, Health Behaviors and Cognition Laboratory, Michigan State University, August 28, 2014
    ...
    function axisHit(varargin)
        ...
        if (Window == 0)
            ...
            templabelout = sprintf('%s from %d to %d ms', ERP.erpname,(temp - Window),(temp + Window));
