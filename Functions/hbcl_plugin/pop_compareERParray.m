function [com] = pop_compareERPArray(INERP)
    ...
    uilist = { ...
      ...
      if ~isempty(structout)
          ...
          com = sprintf('\n%%Equivalent command:\n compareERParray(%s, ''Bin'', %d, ''ChannelScale'', ''%s'', ''Polarity'', ''%s'', ''Smooth'', ''%s'', ''guiSize'', %s, ''guiFontSize'', %d);\n',inputname(1), structout.Bin, structout.ChannelScale, structout.Polarity, structout.Smooth, mat2str(structout.guiSize), structout.guiFontSize);
          disp(com)
          compareERParray(INERP, 'Bin', structout.Bin, 'ChannelScale', structout.ChannelScale, 'Polarity', structout.Polarity, 'Smooth', structout.Smooth,'guiSize', structout.guiSize, 'guiFontSize', structout.guiFontSize);
      else
          com = '';
      end
