%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Fig 5 - suppl 3: cross-validation RSA removing first dim
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
do.dimReduction     = true; % remove dimensions using SVD
...
if do.modelcorr
    ...
    for s = 1:params.nsubj
        ...
        % Load data
        inputfile  = sprintf('Crossval_%03d_RDM_%s_%s_remD1',params.submat(s),params.whichPhase,params.disttype);
