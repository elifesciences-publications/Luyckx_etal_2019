%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Fig 3B: cross-temporal cross-validation RSA excluding diagonal
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if do.modelcorr
    ...
    for s = 1:params.nsubj
        ...
        % Nan diagonal
        for t1 = 1:size(rdm.data,3)
            for t2 = 1:size(rdm.data,4)
                tmp = squeeze(rdm.data(7:12,1:6,t1,t2));
                tmp(logical(eye(6)))        = nan;
                rdm.data(7:12,1:6,t1,t2)    = tmp;
            end
        end
